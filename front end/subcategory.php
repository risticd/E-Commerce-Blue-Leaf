      ...
      <div class="products">
        ...
        <ul>
          <?php
              ...
              $query = "SELECT product_number, product_name, base_price, 
              description, small_image_path FROM product WHERE fk_subcategory_id = {$subcategoryid};";
            ...
            <?php
                ...
                if($num_rows > 0)
                {
                  while($row = mysql_fetch_array($result))
                  {
                    ...
                    if($i != ($num_rows))
                    {
                      echo "<li><a href='#'>{$row['sub_category_name']}</a></li>";
                    }

                    else
                    {
                      echo "<li class='last'><a href='#'>{$row['sub_category_name']}</a></li>";
                    }
                  }
                }
