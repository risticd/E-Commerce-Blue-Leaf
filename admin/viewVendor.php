...
<div id="wrapper">
	...
	<div id="smallRight2">
	  ...
	  <div class="header-right" style="height:40px;">
                    Search by: Vendor Name <input style="width:150px;" id="vendor_search" type="text"></div>
...
$result = mysql_query($sql);
       ...
       echo "<table width='650'>";
		...
		<th class='ui-state-default'>Business Number</th>
...
$next = $page + 1;
		 ...
		 doPages(10, 'viewVendor.php', 'category=vendor', $num_rows); 
