...
function validateCategory() {
	...
	var productCategory = document.forms["category_form"]["sub_category_name"].value;
	var regex1 = /^[a-zA-Z]+$/;
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="category_form" onsubmit="return validateCategory()"/>
   <table width="650">
   <tr><td colspan="2" class="nohightlight"><h4>Add new Sub Category</h4></td></tr>
		
         <td class="nohightlight">Sub Category:</td>
         <td class="nohightlight"><input type="text" name="sub_category_name" name="category_name" value="Please enter sub category" onfocus="if(this.value=='Please enter sub category') this.value='';" onblur="if (this.value == '') this.value = 'Please enter sub category';"></td>
      </tr>
	  <tr>
         <td class="nohightlight"><input type="button" title="Add Product" value="Add Product" onclick="window.location = 'AddCategory.php';">
		 <td class="nohightlight"><input type="submit" name="submit" value="Add Sub Category" /></td>
      </tr>
...
<?php
	...
	?>
			<META HTTP-EQUIV="refresh" CONTENT="3;URL=AddSubCategory.php">
			 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="category_form" onsubmit="return validateCategory()"/>
				<table width="650">
				<tr><td colspan="2"><h4>Sub Category Inserted</h4></td></tr>
				<tr>
				<td>Sub Category:</td>
				<td><input type="text" name="category_name"></td>
				</tr>
				<tr>
				<td><input type="button" title="Add Product" value="Add Product" onclick="window.location = 'AddCategory.php';"></td>
	...
	<?php
		  ...
		  include("connection/connect.php"); 
             ...
             $sql ="INSERT INTO sub_category (sub_category_name) values ('$_POST[sub_category_name]')"; 
...
$sql = "SELECT sub_category_id, sub_category_name FROM sub_category WHERE sub_category_id=sub_category_id";
       ...
       while($row = mysql_fetch_array($result))
{
                ...
                echo "<tr>";
			    echo '<td colspan="2">' . $row['sub_category_name'] . '</td>';
				echo '<td><a href="editSubCategory.php?sub_category_id=' . $row['sub_category_id'] . '"><img src="images/icn_edit.png"></a></td>';
                echo "</tr>"; 
 } 
...
doPages(10, 'AddSubCategory.php', 'category=categoryname', $num_rows); 
