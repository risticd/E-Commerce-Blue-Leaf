...
<div id="wrapper">
	...
	<div id="smallRight2">
	  ...
	  <div class="header-right" style="height:40px;">
                    Search by Name: <input style="width:150px;" id="cust_search" type="text"></div>
...
$sql = "Select * from account where account_type = 1";
       ...
       while($row = mysql_fetch_array($result))
{
                ...
                echo '<td><a href="editCustomerAccount.php?account_id=' . $row['account_id'] . '"><img src="images/icn_edit.png"></a></td>';
                echo "</tr>"; 
        } 
...
$next = $page + 1;
		 ...
		 doPages(10, 'CustomerAccount.php', 'category=products', $num_rows); 
