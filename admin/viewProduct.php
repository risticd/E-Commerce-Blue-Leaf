...
<div id="wrapper">
	...
	<div id="smallRight2">
	  ...
	  <div class="header-right" style="height:40px;" >
                    ...
                    Search by Product Number: <input style="width:150px;" id="product-search" type="text"></div>
...
$sql = "SELECT product.product_id, product.product_number, product.product_name, vendor.vend_name, product.base_price, product.sizes FROM product, vendor WHERE product.fkvendor_id=vendor.vendor_id";
...
doPages(10, 'viewProduct.php', 'category=products', $num_rows); 
